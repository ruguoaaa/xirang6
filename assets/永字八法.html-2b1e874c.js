import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o,c as _,a as n}from"./app-bc8159dd.js";const t={},c=n("p",null,"永字八法",-1),l=n("pre",null,[n("code",null,`《禁经》云：八法起于隶字之始，自崔、张、钟、王传授所用，该于万字墨道之最，不可不明也。隋僧智永发其指趋。授于虞秘监世南，自兹传授彰厥存焉。李阳水云：昔逸少上书，遂历多载，十五年中，偏攻永字，以其八法之势能通一切也。八法者，永字八画是矣。
 ...
 五左上为策
`)],-1),s=n("p",null,"六左下为略",-1),r=n("pre",null,[n("code",null,` 七右上为啄
...
`)],-1),a=[c,l,s,r];function d(i,u){return o(),_("div",null,a)}const h=e(t,[["render",d],["__file","永字八法.html.vue"]]);export{h as default};
